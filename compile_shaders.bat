C:\VulkanSDK\1.3.275.0\Bin\glslc.exe Shaders/gradient.comp -o cmake-build-build-debug/Debug/gradient.comp.spv

C:\VulkanSDK\1.3.275.0\Bin\glslc.exe Shaders/colored_triangle.vert -o cmake-build-build-debug/Debug/colored_triangle.vert.spv

C:\VulkanSDK\1.3.275.0\Bin\glslc.exe Shaders/colored_triangle.frag -o cmake-build-build-debug/Debug/colored_triangle.frag.spv
